...
$serverUploadPath = "root@192.168.0.49:/var/www/updates/downloads/almoxarifado/"
...
$updateJson = @{
    ...
    updateUrl = "http://192.168.0.49/downloads/almoxarifado/$zipFileName"
    changelog = @(
        "Ajustes",
        "Melhorias"
    )
...
scp "$projectPath\version.json" "root@192.168.0.49:/var/www/updates/downloads/almoxarifado/version.json"
...
Copy-Item -Path "$projectPath\Output\Almoxarifado.exe"  -Destination "RedeTemp:"
